...
const AR: Record<string, string> = {
  ...
  'Specify your industry *': 'حدّد مجالك *',
  'e.g. Pet care, Legal services': 'مثال: العناية بالحيوانات، خدمات قانونية',
  'Key Differentiators': 'ميزتك التنافسية',
  'What makes you better than competitors': 'ما الذي يميّزك عن المنافسين',
  "This Month's Focus": 'تركيز هذا الشهر',
  'e.g. Ramadan offers, new launch': 'مثال: عروض رمضان، إطلاق جديد',
  ...
  'Save Calendar as PDF': 'حفظ التقويم كـ PDF',
  'Opened!': 'تم الفتح!',
